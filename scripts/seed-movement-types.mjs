...
const movementTypes = [
  ...
  },
  {
    ...
    name: "Borrow",
    direction: "out",
    desc: "Material borrowed by a maintenance user (for themselves or for one of their workers). Stock is deducted the moment the borrowing is confirmed in the search bot.",
    requireReference: false,
    requireRemarks: false,
    order: 39,
  },
